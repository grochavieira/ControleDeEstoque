...
"}"));
        ...
        lblNomeCliente->setGeometry(QRect(510, 10, 261, 21));
        lblNomeCliente->setFont(font6);
        lblNomeCliente->setStyleSheet(QString::fromUtf8("color: \"black\";\n"
""));
        lblNomeCliente_2 = new QLabel(TelaPedidosCliente);
        lblNomeCliente_2->setObjectName(QString::fromUtf8("lblNomeCliente_2"));
        lblNomeCliente_2->setGeometry(QRect(430, 10, 81, 21));
        QFont font7;
        font7.setFamily(QString::fromUtf8("MS Shell Dlg 2"));
        font7.setPointSize(14);
        lblNomeCliente_2->setFont(font7);
        lblNomeCliente_2->setStyleSheet(QString::fromUtf8("color: \"black\";\n"
""));
        label_2->raise();
        tabPedidosDoCliente->raise();
        lblNomeCliente->raise();
        lblNomeCliente_2->raise();
        ...
        tabPedidosDoCliente->setCurrentIndex(1);
    ...
    void retranslateUi(QDialog *TelaPedidosCliente)
    {
        ...
        lblNomeCliente_2->setText(QCoreApplication::translate("TelaPedidosCliente", "Usu\303\241rio: ", nullptr));
    } // retranslateUi
