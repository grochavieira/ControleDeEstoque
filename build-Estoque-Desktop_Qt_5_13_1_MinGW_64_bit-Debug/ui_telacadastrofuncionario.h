...
"}"));
        ...
        lblSenhaFuncionarioErro->setGeometry(QRect(320, 330, 200, 16));
        lblSenhaFuncionarioErro->setMinimumSize(QSize(150, 16));
        lblSenhaFuncionarioErro->setMaximumSize(QSize(200, 16777215));
...
""));
        ...
        lblUsuarioFuncionarioErro->setGeometry(QRect(320, 280, 171, 16));
        lblUsuarioFuncionarioErro->setMinimumSize(QSize(150, 16));
        lblUsuarioFuncionarioErro->setMaximumSize(QSize(200, 16777215));
...
"}"));
        ...
        lblTelefoneFuncionarioErro->setGeometry(QRect(320, 230, 200, 16));
        lblTelefoneFuncionarioErro->setMinimumSize(QSize(200, 16));
        lblTelefoneFuncionarioErro->setMaximumSize(QSize(200, 16));
