...
public:
    ...
    QLabel *lblErroUsuarioCliente;
    QLabel *lblErroSenhaCliente;
...
"}"));
        ...
        btnAreaCadastroCliente->setGeometry(QRect(40, 440, 241, 21));
        QFont font1;
...
"	border:none;\n"
"}"));
        lblErroUsuarioCliente = new QLabel(frame);
        lblErroUsuarioCliente->setObjectName(QString::fromUtf8("lblErroUsuarioCliente"));
        lblErroUsuarioCliente->setGeometry(QRect(46, 220, 221, 20));
        lblErroUsuarioCliente->setFont(font1);
        lblErroUsuarioCliente->setStyleSheet(QString::fromUtf8("color: \"white\";\n"
""));
        lblErroUsuarioCliente->setAlignment(Qt::AlignCenter);
        lblErroSenhaCliente = new QLabel(frame);
        lblErroSenhaCliente->setObjectName(QString::fromUtf8("lblErroSenhaCliente"));
        lblErroSenhaCliente->setGeometry(QRect(50, 310, 221, 20));
        lblErroSenhaCliente->setFont(font1);
        lblErroSenhaCliente->setStyleSheet(QString::fromUtf8("color: \"white\";\n"
""));
        lblErroSenhaCliente->setAlignment(Qt::AlignCenter);
    ...
    void retranslateUi(QDialog *TelaLoginCliente)
    {
        ...
        lblErroUsuarioCliente->setText(QString());
        lblErroSenhaCliente->setText(QString());
    } // retranslateUi
