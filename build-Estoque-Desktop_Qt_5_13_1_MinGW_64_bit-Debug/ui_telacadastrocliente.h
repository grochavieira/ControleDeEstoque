...
public:
    ...
    void setupUi(QDialog *TelaCadastroCliente)
    {
        ...
        lblUsuarioClienteErro->setGeometry(QRect(320, 344, 191, 16));
...
""));
        ...
        spnNumEnderecoCliente->setFont(font1);
        spnNumEnderecoCliente->setStyleSheet(QString::fromUtf8("background: \"transparent\";\n"
"border: \"tranparent\";\n"
"color: \"white\";"));
...
"}"));
        ...
        lblConfirmarSenhaClienteErro->setGeometry(QRect(320, 430, 171, 16));
...
""));
        ...
        lblSenhaClienteErro->setGeometry(QRect(320, 388, 171, 16));
...
""));
        ...
        lblCepClienteErro->setGeometry(QRect(320, 260, 181, 16));
...
"}"));
    ...
    void retranslateUi(QDialog *TelaCadastroCliente)
    {
        ...
        label_BGcAD->setStyleSheet(QCoreApplication::translate("TelaCadastroCliente", "QLabel{\n"
"	color: \"white\";\n"
"	background-color: \"transparent\" ;\n"
"	font: 8pt \"Caviar Dreams\";\n"
"}\n"
