...
"}"));
        ...
        btnCadastrarNovoFuncionario->setGeometry(QRect(60, 400, 191, 21));
...
"}"));
        ...
        pushButton->setGeometry(QRect(120, 440, 80, 16));
...
"}"));
    ...
    void retranslateUi(QDialog *telaLoginFuncionario)
    {
        ...
        pushButton->setText(QCoreApplication::translate("telaLoginFuncionario", "Home", nullptr));
    } // retranslateUi
